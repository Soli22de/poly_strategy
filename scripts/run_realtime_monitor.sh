...
LATEST_SNAPSHOTS_OUT="${LATEST_SNAPSHOTS_OUT:-data/realtime-monitor-24h-latest-snapshots.ndjson}"
...
MIN_NET_EDGE="${MIN_NET_EDGE:-0.001}"
...
args=(
  ...
  --latest-snapshots-out "$LATEST_SNAPSHOTS_OUT"
